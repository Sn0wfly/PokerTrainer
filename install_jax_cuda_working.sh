...
echo "🔧 INSTALLING WORKING JAX CUDA VERSION..."
...
# Install the correct CUDA-enabled jaxlib version that exists
echo "📦 Installing CUDA-enabled jaxlib (version that exists)..."
...
# Install compatible JAX version
echo "📦 Installing compatible JAX..."
